...
namespace wardrobe.Controllers
{
    public class AccessoryTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryTypeID,AccessoryName")] AccessoryType accessoryType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryTypeID,AccessoryName")] AccessoryType accessoryType)
        {
            if (ModelState.IsValid)
            {
